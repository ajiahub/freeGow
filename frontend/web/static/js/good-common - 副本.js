...
jQuery(document).ready(function(){
	...
	jQuery(".fileuploadform input[type=file]").change(function(){
		...
		fileDom.wrap('<form action="/good/goodpicupload" method="post" enctype="multipart/form-data"></form>');
