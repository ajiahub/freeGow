...
class ResizeImage
{
    public static function resize($src, $width, $height, $level = 75, $mode = 'crop')
    {
        ...
        $newDir = 'attachment/' . $username.'/'.$width.'_'.$height;
        ...
        return Yii::$app->params ['imgUrl'] . $newDir . '/' . basename($src);
    }
