...
var provinceList = [
{name:'省份', cityList:[{name:'城市', areaList:['区/县']}]},
{name:'北京', cityList:[		   
...
{name:'重庆', cityList:[		   
{name:'市辖区', areaList:['江津区','合川区','永川区','南川区','万州区','涪陵区','渝中区','大渡口区','江北区','沙坪坝区','九龙坡区','南岸区','北碚区','万盛区','双桥区','渝北区','巴南区','黔江区','长寿区']},
...
{name:'贵州', cityList:[		   
{name:'贵阳市', areaList:['南明区','云岩区','花溪区','乌当区','白云区','小河区','开阳县','息烽县','修文县','清镇市','观山湖区']},
...
{name:'河南', cityList:[		   
{name:'郑州市', areaList:['中原区','二七区','管城回族区','金水区','上街区','邙山区','中牟县','巩义市','荥阳市','新密市','新郑市','登封市','惠济区']},
...
{name:'焦作市', areaList:['解放区','中站区','马村区','山阳区','修武县','博爱县','武陟县','温　县','沁阳市','孟州市']},
	{name:'济源市', areaList:['济水街道','北海街道','天坛街道','沁园街道','玉泉街道','克井镇','五龙口镇','梨林镇','轵城镇','承留镇','坡头镇','大峪镇','邵原镇','思礼镇','王屋镇','下冶镇']},
...
{name:'信阳市', areaList:['浉河区','平桥区','罗山县','光山县','新　县','商城县','固始县','潢川县','淮滨县','息　县']},
...
{name:'广东', cityList:[		   
{name:'广州市', areaList:['东山区','荔湾区','越秀区','海珠区','天河区','萝岗区','芳村区','白云区','黄埔区','番禺区','花都区','增城市','从化市','南沙区']},
{name:'韶关市', areaList:['武江区','浈江区','曲江区','始兴县','仁化县','翁源县','乳源瑶族自治县','新丰县','乐昌市','南雄市']},		   
{name:'深圳市', areaList:['罗湖区','福田区','南山区','宝安区','龙岗区','盐田区','龙华新区']},
...
{name:'吴忠市', areaList:['红寺堡区','利通区','盐池县','同心县','青铜峡市']},
{name:'固原市', areaList:['原州区','西吉县','隆德县','泾源县','彭阳县']},
{name:'中卫市', areaList:['沙坡头区','中宁县','海原县']}
]},
{name:'新疆', cityList:[		   
{name:'乌鲁木齐市', areaList:['天山区','沙依巴克区','新市区','水磨沟区','头屯河区','达坂城区','东山区','乌鲁木齐县','米东区']},
...
{name:'无锡市', areaList:['新吴区','梁溪区','锡山区','惠山区','滨湖区','江阴市','宜兴市']},
{name:'徐州市', areaList:['鼓楼区','云龙区','九里区','贾汪区','泉山区','丰　县','沛　县','铜山县','睢宁县','新沂市','邳州市']},		   
{name:'常州市', areaList:['天宁区','钟楼区','戚墅堰区','新北区','武进区','溧阳市','金坛市']},		   
{name:'苏州市', areaList:['沧浪区','平江区','金阊区','虎丘区','吴中区','相城区','常熟市','张家港市','昆山市','吴江市','太仓市','新区','工业园区']},
...
{name:'安徽', cityList:[		   
{name:'合肥市', areaList:['瑶海区','庐阳区','蜀山区','包河区','长丰县','肥东县','肥西县','巢湖市']},
{name:'芜湖市', areaList:['镜湖区','马塘区','新芜区','鸠江区','芜湖县','繁昌县','南陵县','三山区','弋江区']},
...
{name:'九江市', areaList:['庐山区','浔阳区','九江县','武宁县','修水县','永修县','共青城市','德安县','星子县','都昌县','湖口县','彭泽县','瑞昌市']},
...
{name:'吉林', cityList:[		   
{name:'长春市', areaList:['南关区','宽城区','朝阳区','二道区','绿园区','双阳区','农安县','九台市','榆树市','德惠市','净月区','汽车产业开发区','高新技术开发区','经济技术开发区']},
...
{name:'大兴安岭地区', areaList:['呼玛县','塔河县','漠河县','加格达奇区','松岭区','呼中区','新林区']}
]},
{name:'海南', cityList:[		   
{name:'海口市', areaList:['秀英区','龙华区','琼山区','美兰区']},		   
{name:'三亚市', areaList:['城区']},		   
